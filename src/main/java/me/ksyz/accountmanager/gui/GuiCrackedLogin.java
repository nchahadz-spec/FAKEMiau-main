...
public class GuiCrackedLogin extends GuiScreen {
    ...
    public void initGui() {
        ...
        buttonList.add(new GuiButton(
                998, sr.getScaledWidth() / 2 - 100, sr.getScaledHeight() / 2 + 30, 200, 20, "Add Cracked"
        ));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(
                fontRendererObj, "Cracked Account",
    ...
    protected void actionPerformed(GuiButton button) {
        ...
        mc.displayGuiScreen(new GuiAccountManager(
                ...
                new Notification(TextFormatting.translate(String.format(
                        exists ? "&eCracked account already exists! Logged in as %s&r" : "&aAdded cracked account! (%s)&r",
                        session.getUsername()
                )), 5000L)
        ));
    }
